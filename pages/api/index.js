...
function APIDocumentation() {
  ...
  const publicEndpoints = [
    ...
    {
      name: 'All Leagues',
      endpoint: '/api/matches/leagues/all',
      description: 'Get all leagues data',
    },
    {
      name: 'Popular Matches',
      endpoint: '/api/matches/popular',
      description: 'Get popular matches',
    },
    {
  ...
  function showTab(tabName) {
    ...
    const buttons = document.querySelectorAll(
      '#external-tab-btn, #public-tab-btn, #protected-tab-btn'
    )
        ...
        React.createElement('div', { key: 'container', className: 'max-w-6xl mx-auto p-6' }, [
          ...
          React.createElement(
            ...
            [
              ...
              React.createElement(
                'div',
                { key: 'badges', className: 'flex justify-center gap-3 flex-wrap' },
                [
                  React.createElement(
                    'span',
                    {
          ...
          React.createElement(
            'div',
            { key: 'tabs', className: 'bg-white rounded-xl overflow-hidden shadow-xl' },
            [
              React.createElement(
                'div',
                { key: 'tab-buttons', className: 'flex bg-gray-50 border-b' },
                [
                  React.createElement(
                    'button',
                    {
              ...
              React.createElement('div', { key: 'tab-content', className: 'p-8' }, [
                ...
                React.createElement(
                  'div',
                  { key: 'external-panel', id: 'external', className: 'tab-panel' },
                  [
                    React.createElement(
                      'h2',
                      {
                          ...
                          [
                            ...
                            React.createElement(
                              'div',
                              {
                                key: 'path',
                                className:
                                  'bg-gray-50 p-4 rounded-lg border-l-4 border-l-primary mb-4',
                              },
                              [
                                React.createElement(
                                  'code',
                ...
                React.createElement(
                  'div',
                  { key: 'public-panel', id: 'public', className: 'tab-panel hidden' },
                  [
                    React.createElement(
                      'h2',
                      {
                      ...
                      [
                        React.createElement(
                          'span',
                          { key: 'icon', className: 'text-green-500' },
                          '🌍'
                        ),
                        'Public Endpoints',
                      ]
                          ...
                          [
                            ...
                            React.createElement(
                              'div',
                              {
                                key: 'path',
                                className:
                                  'bg-gray-50 p-3 rounded-lg flex justify-between items-center',
                              },
                              [
                                React.createElement(
                                  'code',
                ...
                React.createElement(
                  'div',
                  { key: 'protected-panel', id: 'protected', className: 'tab-panel hidden' },
                  [
                    React.createElement(
                      'h2',
                      {
                      ...
                      [
                        React.createElement(
                          'span',
                          { key: 'icon', className: 'text-orange-500' },
                          '🔒'
                        ),
                        'Protected Endpoints',
                      ]
          ...
          React.createElement(
            'div',
            { key: 'database', className: 'bg-white rounded-xl p-8 mt-8 shadow-xl' },
            [
              React.createElement(
                'h2',
                { key: 'db-title', className: 'text-2xl font-bold mb-4 flex items-center gap-3' },
                [
                  React.createElement('span', { key: 'icon', className: 'text-purple-500' }, '🗄️'),
                  'Database Schema',
                ]
              ),
              React.createElement(
              ...
              React.createElement(
                ...
                [
                  ...
                  React.createElement(
                    ...
                    {
                      key: `table-${index}`,
                      className: 'bg-gray-50 p-4 rounded-lg border-l-4 border-l-gray-400',
                    },
                    [
                      React.createElement(
                        'h4',
