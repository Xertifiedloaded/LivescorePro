-- Setup script for macOS PostgreSQL
-- Run this with: psql -d football_betting -f scripts/setup-database-macos.sql
...
-- Create leagues table with all columns
...
-- Create matches table with all columns
